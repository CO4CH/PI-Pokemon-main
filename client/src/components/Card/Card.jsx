...
// Definición del componente Card usando Styled Components
export default function Card({ name, sprite, types }) {      

    // Creación de un componente de contenedor estilizado usando styled-components
            ...
            <div className={styles.container}>
                <div>
                    ...
                    <div className={styles.types}>
                        {types?.map((type) => {
                            // Determinar el tipo de nombre según si es un objeto o no
